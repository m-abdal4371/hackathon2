...
const Footer = () => {
  return (
    ...
    <div>
    <div className="bg-gray-200 text-indigo-950 mt-14 px-4 sm:px-6 lg:px-12 xl:px-20">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div className=" mt-1 flex flex-col items-center">
          ...
          <div className="flex items-center space-x-2 w-full max-w-[400px]">
            ...
            />
            <button className="bg-pink-500 rounded text-white w-24 h-8 hover:bg-pink-600">
              Sign Up
            </button>
          </div>
          <ul className="mt-8">
        ...
        <div className=' mt-1 flex-col items-center'>
          ...
          <ul className="mt-4">
            ...
            <li className="mt-4">Orders History</li>
            <li className="mt-4 mb-6">Order Tracking</li>
          </ul>
        </div>
